...
const variants: Record<Variant, string> = {
  primary:
    "bg-primary text-white hover:bg-primary-light px-7 py-3.5 shadow-sm hover:shadow-md",
  secondary:
    "bg-surface text-primary border border-border hover:border-primary/30 px-7 py-3.5",
  outline:
    "border border-white/30 text-white hover:bg-white/10 px-7 py-3.5",
  ghost: "text-muted hover:text-primary px-4 py-2",
  accent:
